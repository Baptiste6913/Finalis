...
TESTS = ['lint_modules.py', 'test_server.py', 'test_engine.py', 'test_hl.py', 'test_pdfedit.py', 'test_flow.py', 'test_landing.py', 'test_platforms.py', 'test_edit.py', 'test_login.py', 'test_desk.py', 'test_learning.py', 'test_memory.py', 'test_more.py']
