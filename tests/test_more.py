...
async def main():
    async with async_playwright() as pw:
        ...
        res = await page.evaluate("""async () => {
          const r = await fetch('test.docx'); const bytes = new Uint8Array(await r.arrayBuffer());
        ...
        await page.screenshot(path='shot_image.png')
        await browser.close()
        # 4) mobile + dark
        browser, page = await open_page(pw, width=400, height=820, init_script=FAKE)
        await page.emulate_media(color_scheme='dark')
        await page.wait_for_timeout(500)
        await page.screenshot(path='shot_mobile_form_dark.png', full_page=True)
        ...
        await page.screenshot(path='shot_mobile_work_dark.png')
        await page.click('#rail-toggle'); await page.wait_for_timeout(300)
        await page.screenshot(path='shot_mobile_rail_dark.png')
