...
async def main():
    async with async_playwright() as pw:
        ...
        await page.screenshot(path=os.path.join(OUT, 'shot_card_ai.png'))
        await page.click('#btn-rulebook-2'); await page.wait_for_timeout(300)
        await page.screenshot(path=os.path.join(OUT, 'shot_rulebook.png'))
        ...
        await page.screenshot(path=os.path.join(OUT, 'shot_mobile_dark2.png'))
        await browser.close()
asyncio.run(main())
