...
const PdfOut = (() => {
  ...
  const SEV = { high: { rgb: [0.71, 0.14, 0.09], label: 'High' }, medium: { rgb: [0.71, 0.28, 0.03], label: 'Medium' }, low: { rgb: [0.02, 0.46, 0.28], label: 'Low' }, pending: { rgb: [0.41, 0.25, 0.78], label: 'Pending' }, ok: { rgb: [0.02, 0.46, 0.28], label: 'Yes' }, no: { rgb: [0.45, 0.45, 0.45], label: 'No' }, flag: { rgb: [0.71, 0.14, 0.09], label: 'Yes' }, open: { rgb: [0.71, 0.14, 0.09], label: 'Open' }, done: { rgb: [0.02, 0.46, 0.28], label: 'Resolved' } };
